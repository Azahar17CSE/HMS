<?php
    ...
    $id=$_GET['sid'];
    $select="SELECT * FROM user INNER JOIN room ON user.room_id=room.room_id INNER JOIN department ON user.department_id=department.department_id WHERE user.sid='$id' ORDER BY user.id DESC";
...
<div class="container"> 
    <h1 class="text-center text-primary"><b>Student Details</b></h1>
                <hr>
                <div class="row">
                <div class="card-body">
                    <?php
