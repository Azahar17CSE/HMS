<?php
    ...
    $id=$_GET['r'];
    $select="SELECT * FROM user INNER JOIN room ON user.room_id=room.room_id INNER JOIN department ON user.department_id=department.department_id WHERE user.room_id='$id' ORDER BY user.id DESC";
...
<div class="container"> 
    <h1 class="text-center text-primary"><b>Room Details</b></h1>
                <hr>
                <div class="row">
                <div class="card-body">
                    <?php
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="text-center text-danger"><b><?= $c.'. '. $data['name'] ?></b></h2>
                        </div>
                    </div>
                    <br>
                    <div class="row">
