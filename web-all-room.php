...
<br>
        ...
        <div class="container">
                <h1 class="text-center text-primary"><b>Hall Room</b></h1> 
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="text-center"><b><a href="web-room-details.php?r=<?= $data['room_id'] ?>" class="text-danger"><?= $data['room_no'] ?></a></b></h2>
                        </div>
                    </div>
                    <br>                    
