...
<div class="container">
        ...
        <form method="get" action="web-details-dept.php">

          <h1 class="text-center text-primary"><b><input name="department" type="text" required><br><button type="submit" class="btn btn-danger btn-lg">Search</button></b></h1> 
